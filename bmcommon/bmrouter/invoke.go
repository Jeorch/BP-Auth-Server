...
func InvokeSkeleton(w http.ResponseWriter, r *http.Request,
	bks bmbrick.BMBrickFace, pkg string, idx int64) {
...
func NextBrickRemote(pkg string, idx int64, face bmbrick.BMBrickFace) {
...
func ForWardNextBrick(host string, port string, pkg string, idx int64, face bmbrick.BMBrickFace) {
